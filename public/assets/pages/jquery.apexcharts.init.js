...
let restday = document.getElementById('restday');
let gh = document.getElementById('gh');
let halfday = document.getElementById('halfday');
let absent = document.getElementById('absent');
let casualleaveCount = document.getElementById('casualleaveCount');
let casualleave1Count = document.getElementById('casualleave1Count');
let sickleaveCount = document.getElementById('sickleaveCount');

var watch = [present.value,restday.value,gh.value,halfday.value,absent.value,casualleaveCount.value,casualleave1Count.value,sickleaveCount.value]
...
series: [result[0],result[1],result[2],result[3],result[4],result[5],result[6],result[7]],
labels: ["Present", "Rest Day","Public Holiday", "Half Day", "Absent","Casual Leave", "1/2 Casual Leave", "1/2 Sick Leave",],
colors: ["#1eca7b","#0dc8de","#ffb822","#1c2d41","#f14b4b","#f14b4b","#f14b4b","#f14b4b"],
legend: {
    show: true,
    position: 'bottom',
...
var colors = ['rgb(241, 75, 75)', 'rgb(30, 202, 123)', '#0dc8de', '#ffb822'];
var options = {
  chart: {
      height: 300,
      type: 'bar',
  ...
  series: [{
      name: '',
      data: [ result[4],result[0],result[1],result[2]]
  }],
  xaxis: {
      categories: ["Absent", "Present", "Rest Day", "Public Holiday"],
      position: 'top',
      labels: {
          offsetY: -18,
          style: {
