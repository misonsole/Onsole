        ...
        $('#cuttingrow').append(
                            '<div id="cuttingrow'+i+'" name="cutting" class="form-group row mb-2">'+
                                ...
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_fac" name="cut_fac[]" placeholder="Factor">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_qty" name="cut_qty[]" placeholder="Quantity">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1">'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_process" name="cut_process[]" placeholder="%">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
    ...
    $('#insole').click(function(){
        ...
        $('#insolerow').append(
                            '<div id="insolerow'+i+'" name="insole" class="form-group row mb-2">'+
                                ...
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_qty" name="i_qty[]" placeholder="Quantity">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1">'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_process" name="i_process[]" placeholder="%">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
    ...
    $('#lamination').click(function(){
        ...
        $('#laminationrow').append(
                            '<div id="laminationrow'+i+'" name="lamination" class="form-group row mb-2">'+
                                ...
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_qty" name="lam_qty[]" placeholder="Quantity">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1">'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_process" name="lam_process[]" placeholder="%">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_total_con" name="lam_total_con[]" placeholder="Total">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1 text-center">'+
    ...
    $('#closing').click(function(){
        ...
        $('#closingrow').append(
                            '<div id="closingrow'+i+'" name="closing" class="form-group row mb-2">'+
                                ...
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_qty" name="clo_qty[]" placeholder="Quantity">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1">'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_process" name="clo_process[]" placeholder="%">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_total_con" name="clo_total_con[]" placeholder="Total">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1 text-center">'+
    ...
    $('#lasting').click(function(){
        ...
        $('#lastingrow').append(
                            '<div id="lastingrow'+i+'" name="lasting" class="form-group row mb-2">'+
                                ...
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_qty" name="last_qty[]" placeholder="Quantity">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1">'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_process" name="last_process[]" placeholder="%">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_total_con" name="last_total_con[]" placeholder="Total">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1 text-center">'+
    ...
    $('#packing').click(function(){
        ...
        $('#packingrow').append(
                            '<div id="packingrow'+i+'" name="packing" class="form-group row mb-2">'+
                                ...
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_qty" name="p_qty[]" placeholder="Quantity">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1">'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_process" name="p_process[]" placeholder="%">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1" hidden>'+
                                    '<input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_total_con" name="p_total_con[]" placeholder="Total">'+
                                '</div>'+
                                '<div class="col-sm-1 py-1 text-center">'+
