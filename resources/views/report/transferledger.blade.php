            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Transfer Ledger Report</li>
                    </ol>
                </div>
                <h4 class="page-title">Transfer Ledger Report</h4>
                <br>
...
<div class="modal fade bd-example-modal-lg" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content" style="margin-top: 15%;">
        ...
        <h5 class="modal-title" id="exampleModalLongTitle">Transfer Ledger Report</h5>
            ...
            <div class="card-body px-5 py-1">
                <form method="post" enctype="multipart/form-data" id="myForm">
                    ...
                    <div class="form-group row py-2">
                        ...
                        <div class="col-sm-6 mb-1 mb-sm-0" hidden>
...
$("#submit").click(function(){
    $("#myForm").attr("action", "transfer-ledger-report");
    document.getElementById("myForm").submit();
});
$("#download").click(function(){
    $("#myForm").attr("action", "transfer-ledger-report-download");
    document.getElementById("myForm").submit();
});
