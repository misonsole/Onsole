            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Material Transfer Against All Job Order</li>
                    </ol>
                </div>
                <h4 class="page-title">Material Transfer Against All Job Order</h4>
                <br>
            ...
            <div class="card">
                ...
                <div class="row px-5">
                        ...
                        <div class="col-md-6 align-self-center text-center">
                            <h3>Material Transfer Against All Job Order</h3>
                        </div>
                    </div>
                    @if($Permission == 1)
...
$("#submit").click(function(){
    $("#myForm").attr("action", "transferagainstall-report");
    document.getElementById("myForm").submit();
});
$("#download").click(function(){
    $("#myForm").attr("action", "transferagainstall-report-download");
    document.getElementById("myForm").submit();
});
