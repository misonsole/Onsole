            ...
            <div class="modal-body">
                ...
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-center">
                            <button type="submit" style="float: right; border: none; font-size: 17px; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6));" class="btn px-5 py-1 btn-lg btn-block text-white mt-3">Assign Books</button>  
                        </div>
                        <div class="col-4 text-center">
                        </div>
                    </div>
