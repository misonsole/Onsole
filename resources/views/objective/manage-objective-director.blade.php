        ...
        <div class="row px-1">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Manage Users<a href="{{url('all-objective')}}"> <button type="button" style="background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)); border: none;" class="btn px-3 py-1 text-white mx-3">View All Objectives</button></a></h4>                    
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="show-obj">
                                                ...
                                                <button type="submit" class="btn btn-outline-dark btn-sm px-5">View</button>
