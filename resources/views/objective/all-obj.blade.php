                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($user->rating == 1) 
                                            ...
                                            @endif
                                                <span id="{{$user->rate}}" data-id={{$user['id']}} val="{{$user->memberName}}" data-toggle="modal" data-target="#exampleModalCenter67" class="badge cursor-pointer ratebtn" style="cursor: pointer; font-size: small; font-weight: 500;">
                                                    <i style="font-size: large;" class="typcn typcn-star"></i>
                                                </span>
                                        @endif 
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            @elseif($user->objStatus == 2)
                                                <span class="badge badge-soft-success p-2">In-Review HR</span>
                                            @elseif($user->objStatus == 3)
                                                <span class="badge badge-soft-danger p-2">Revision</span>
                                            ...
                                            @elseif($user->objStatus == 4)
                                                <span class="badge badge-soft-secondary p-2">Finalised</span>
                                            @endif
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <span class="badge badge-dark p-2 w-100">{{$total}}<span style="margin-left: 3%;"></span></span>
                                        </th>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data){
                    ...
                    if(data.objStatus == 1){
                        $('#objStatus').html("Pending");
                    }
                    else if(data.objStatus == 2){
                        $('#objStatus').html("In-Review HR");
                    }                    
                    else if(data.objStatus == 3){
                        $('#objStatus').html("Revision");
                    }                    
                    else if(data.objStatus == 4){
                        $('#objStatus').html("Finalised");
                    }
