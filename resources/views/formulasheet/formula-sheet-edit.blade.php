            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('pricing-sheet-table')}}">Manage Formula Sheet</a></li>
                        <li class="breadcrumb-item active" style="font-family: 'Poppins', sans-serif;">Edit Formula Sheet</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Formula Sheet</h4>
            </div>
        </div>
    </div>
    <div class="row mb-5">
