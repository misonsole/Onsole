                    ...
                    @csrf
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="cutting" type="button" class="btn btn-outline-primary btn-round px-4 mb-2" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="cuttingrow">
                            @if(!$cuttingData)
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="insole" type="button" class="btn btn-outline-primary btn-round px-4 mb-2" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="insolerow">
                            @if(!$InsoleData)
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="lamination" type="button" class="btn btn-outline-primary btn-round px-4 mb-2" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="closing" type="button" class="btn btn-outline-primary btn-round px-4 mb-2" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="closingrow">
                            @if(!$ClosingData)
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="lasting" type="button" class="btn btn-outline-primary btn-round px-4 mb-2" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="lastingrow">
                            @if(!$LastingData)
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="packing" type="button" class="btn btn-outline-primary btn-round px-4 mb-2" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="packingrow">
                            @if(!$PackingData)
