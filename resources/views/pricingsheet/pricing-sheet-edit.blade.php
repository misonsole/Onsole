            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-family: 'Poppins', sans-serif;">Edit Pricing Sheet</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Pricing Sheet</h4>
            </div>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-lg-12 mb-5">
            <div class="card">
                <div class="card-body p-5">
                    <form action="{{url('pricing-sheet-update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-sm-8 col-md-8 py-0">
                                ...
                                <div class="form-group row py-0">
                                    <div class="col-sm-3 col-md-3 py-1">
                                        ...
                                        <input value="{{$userpurpose}}" id="purpose" name="purpose" type="text" class="form-control yourclass" style="border: 1px solid #bfbfbf;" placeholder="Purpose">
                                    </div>
                                    <div class="col-sm-3 col-md-3 py-1">
                                        <label><b style="color: #6c757d">Product</b></label>
                                        <input value="{{$userproduct}}" id="product" name="product" type="text" class="form-control yourclass" style="border: 1px solid #bfbfbf;" placeholder="Product">
                                    </div>
                                    <div class="col-sm-6 col-md-6 py-1">
                            ...
                            <div class="col-sm-4 col-md-4 py-1">
                                <div class="form-group row py-0">
                                    <div class="col-md-6 py-0">
                                        ...
                                        <div class="row py-0">
                                            <div class="col-sm-12">
                                                <label class="mt-0"><b style="color: #6c757d">Date</b></label>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="cutting" type="button" class="btn btn-outline-primary btn-round px-4 mb-2 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="cuttingrow">
                            @if(!$cuttingData)
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="cut_item_code1" type="text" name="cut_item_code[]" style="border: 1px solid #bfbfbf;" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_fac" name="cut_fac[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".0001" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_qty" name="cut_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_total_con" name="cut_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button type="button" class="btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @else
                            ...
                            <div id="insolerow1{{$a1++}}" class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="cut_item_code1" value="{{$data->item_code}}" type="text" style="border: 1px solid #bfbfbf;" name="cut_item_code[]" class="form-control py-2" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                        <a data-toggle="modal" onclick="myFunction1('1', 'cutting')" data-id="1" data-target="#exampleModalCenter" style="font-size: small; cursor: pointer; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)) !important; border: none;" class="btn text-white ModelBtn ml-2 py-0 px-2"><i style="font-size: 20px;" class="mdi mdi-progress-upload"></i></a>                                        
                                    </span>
                                ...
                                <div class="col-sm-2 py-1">
                                    <input type="text" value="{{$data->description}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description1" name="cut_description[]" placeholder="Description">
                                </div>
                                <div class="col-sm-1 py-1">
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input value="{{$data->fac_qty}}" type="number" step=".01" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_fac" name="cut_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input value="{{$data->total_qty}}" type="number" step=".0001" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_qty" name="cut_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" value="{{$data->process}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_process" name="cut_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input value="{{$data->total}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_total_con" name="cut_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button id="{{$a2++}}" type="button" class="removeRow1 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="insole" type="button" class="btn btn-outline-primary btn-round px-4 mb-2 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="insolerow">
                            @if(!$InsoleData)
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="i_item_code1" type="text" name="i_item_code[]" style="border: 1px solid #bfbfbf;" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_fac" name="i_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".0001" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_qty" name="i_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_total_con" name="i_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button type="button" class="btn btn-outline-danger btn-round px-4 w-100 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @else
                            ...
                            <div id="insolerow2{{$b1++}}" class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="i_item_code1" value="{{$data->item_code}}" type="text" style="border: 1px solid #bfbfbf;" name="i_item_code[]" class="form-control py-2" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                        <a data-toggle="modal" onclick="myFunction1('1', 'insole')" data-id="1" data-target="#exampleModalCenter" style="font-size: small; cursor: pointer; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)) !important; border: none;" class="btn text-white ModelBtn_l ml-2 py-0 px-2"><i style="font-size: 20px;" class="mdi mdi-progress-upload"></i></a>                                        
                                    </span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_fac" name="i_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total_qty}}" step=".0001" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_qty" name="i_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" value="{{$data->process}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_process" name="i_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_total_con" name="i_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button id="{{$b2++}}" type="button" class="removeRow2 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="lamination" type="button" class="btn btn-outline-primary btn-round px-4 mb-2 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="laminationrow">
                            ...
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="lam_item_code1" type="text" name="lam_item_code[]" style="border: 1px solid #bfbfbf;" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_fac" name="lam_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".0001" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_qty" name="lam_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_process" name="lam_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_total_con" name="lam_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button type="button" class="btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            ...
                            <div id="insolerow3{{$c1++}}" class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="lam_item_code1" value="{{$data->item_code}}" style="border: 1px solid #bfbfbf;" type="text" name="lam_item_code[]" class="form-control py-2" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                        <a data-toggle="modal" onclick="myFunction1('1', 'lamination')" data-id="1" data-target="#exampleModalCenter" style="font-size: small; cursor: pointer; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)) !important; border: none;" class="btn text-white ModelBtn_l ml-2 py-0 px-2"><i style="font-size: 20px;" class="mdi mdi-progress-upload"></i></a>                                        
                                    </span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_fac" name="lam_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total_qty}}" step=".0001" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_qty" name="lam_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" value="{{$data->process}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_process" name="lam_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_total_con" name="lam_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button id="{{$c2++}}" type="button" class="removeRow3 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="closing" type="button" class="btn btn-outline-primary btn-round px-4 mb-2 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="closingrow">
                            @if(!$ClosingData)
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="clo_item_code1" type="text" name="clo_item_code[]" style="border: 1px solid #bfbfbf;" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_fac" name="clo_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".0001" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_qty" name="clo_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_process" name="clo_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_total_con" name="clo_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button type="button" class="btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            ...
                            <div id="insolerow4{{$d1++}}" class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="clo_item_code1" value="{{$data->item_code}}" style="border: 1px solid #bfbfbf;" type="text" name="clo_item_code[]" class="form-control py-2" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                        <a data-toggle="modal" onclick="myFunction1('1', 'closing')" data-id="1" data-target="#exampleModalCenter" style="font-size: small; cursor: pointer; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)) !important; border: none;" class="btn text-white ModelBtn_l ml-2 py-0 px-2"><i style="font-size: 20px;" class="mdi mdi-progress-upload"></i></a>                                        
                                    </span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_fac" name="clo_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total_qty}}" step=".0001" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_qty" name="clo_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" value="{{$data->process}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_process" name="clo_process[]" placeholder="%">
                                </div> 
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_total_con" name="clo_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button id="{{$d2++}}" type="button" class="removeRow4 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="lasting" type="button" class="btn btn-outline-primary btn-round px-4 mb-2 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="lastingrow">
                            @if(!$LastingData)
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_fac" name="last_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".0001" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_qty" name="last_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_process" name="last_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_total_con" name="last_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button type="button" class="btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            ...
                            <div id="insolerow5{{$e1++}}" class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="last_item_code1" value="{{$data->item_code}}" style="border: 1px solid #bfbfbf;" type="text" name="last_item_code[]" class="form-control py-2" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                        <a data-toggle="modal" onclick="myFunction1('1', 'lasting')" data-id="1" data-target="#exampleModalCenter" style="font-size: small; cursor: pointer; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)) !important; border: none;" class="btn text-white ModelBtn_l ml-2 py-0 px-2"><i style="font-size: 20px;" class="mdi mdi-progress-upload"></i></a>                                        
                                    </span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_fac" name="last_fac[]" placeholder="Factor">
                                </div> 
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total_qty}}" step=".0001" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_qty" name="last_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" value="{{$data->process}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_process" name="last_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_total_con" name="last_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button id="{{$e2++}}" type="button" class="removeRow5 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="packing" type="button" class="btn btn-outline-primary btn-round px-4 mb-2 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="packingrow">
                            @if(!$PackingData)
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="p_item_code1" type="text" name="p_item_code[]" style="border: 1px solid #bfbfbf;" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_fac" name="p_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" step=".0001" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_qty" name="p_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_process" name="p_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" class="form-control py-2 yourclass yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_total_con" name="p_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button type="button" class="btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            ...
                            <div id="insolerow6{{$f1++}}" class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span>
                                        <input id="p_item_code1" value="{{$data->item_code}}" style="border: 1px solid #bfbfbf;" type="text" name="p_item_code[]" class="form-control py-2" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                        <a data-toggle="modal" onclick="myFunction1('1', 'packing')" data-id="1" data-target="#exampleModalCenter" style="font-size: small; cursor: pointer; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)) !important; border: none;" class="btn text-white ModelBtn_l ml-2 py-0 px-2"><i style="font-size: 20px;" class="mdi mdi-progress-upload"></i></a>                                        
                                    </span>
                                ...
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_fac" name="p_fac[]" placeholder="Factor">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total_qty}}" step=".0001" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_qty" name="p_qty[]" placeholder="Quantity">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input step="0.1" min="0" type="number" value="{{$data->process}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_process" name="p_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                                    <input type="number" value="{{$data->total}}" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_total_con" name="p_total_con[]" placeholder="Total">
                                </div>
                                <div class="col-sm-1 py-1 text-center">
                                    <button id="{{$f2++}}" type="button" class="removeRow6 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div class="form-group row mb-0 mt-5">
                            ...
                            <div class="col-sm-1 text-center">
                                <button id="manual" type="button" class="btn btn-outline-primary btn-round px-4 w-100 mb-3" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-plus"></i></button>
                            </div>
                        </div>
                        <div id="manualrow">
                            @if($check == 0)
                            ...
                            @else
                            @foreach($manual as $manualtext)
                                <div id="insolerow7{{$g1++}}" class="form-group row">
                                    <div class="col-sm-5">
                                        <input type="text" value="{{$manualtext}}" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="manualtext" name="manualtext[]" placeholder="Manual">
                                    </div>
                                    <div class="col-sm-1">
                                        <button id="{{$g2++}}" type="button" class="removeRow7 btn btn-outline-danger btn-round px-4 w-100" aria-haspopup="true" aria-expanded="false"><i style="font-size: 15px;" class="mdi mdi-minus"></i></button>
                                    </div>
                                    <div class="col-sm-6">
                                    </div>
                                </div>
