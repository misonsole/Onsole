                            ...
                            @csrf
                                ...
                                <div id="cuttingrow">
                                    ...
                                    <div id="insolerow1{{$a1++}}" class="form-group row mb-2 text-center">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input step="0.1" min="0" value="{{$data->rate}}" type="number" class="form-control py-2 text-center" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate" name="cut_rate[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                ...
                                <div id="insolerow">
                                    ...
                                    <div id="insolerow2{{$b1++}}" class="form-group row mb-2 text-center">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input step="0.1" min="0" value="{{$data->rate}}" type="number" class="form-control py-2 text-center" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate" name="i_rate[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <p class="py-2" style="font-family: 'Poppins', sans-serif;">{{$data->value}}</p> 
                                ...
                                <div id="laminationrow">
                                    ...
                                    <div id="insolerow3{{$c1++}}" class="form-group row mb-2 text-center">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input step="0.1" min="0" value="{{$data->rate}}" type="number" class="form-control py-2 text-center" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate" name="lam_rate[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <p class="py-2" style="font-family: 'Poppins', sans-serif;">{{$data->value}}</p> 
                                ...
                                <div id="closingrow">
                                    ...
                                    <div id="insolerow4{{$d1++}}" class="form-group row mb-2 text-center">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input step="0.1" min="0" value="{{$data->rate}}" type="number" class="form-control py-2 text-center" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate" name="clo_rate[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <p class="py-2" style="font-family: 'Poppins', sans-serif;">{{$data->value}}</p> 
                                ...
                                <div id="lastingrow">
                                    ...
                                    <div id="insolerow5{{$e1++}}" class="form-group row mb-2 text-center">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input step="0.1" min="0" value="{{$data->rate}}" type="number" class="form-control py-2 text-center" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate" name="last_rate[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <p class="py-2" style="font-family: 'Poppins', sans-serif;">{{$data->value}}</p> 
                                ...
                                <div id="packingrow">
                                    ...
                                    <div id="insolerow6{{$f1++}}" class="form-group row mb-2 text-center">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input step="0.1" min="0" value="{{$data->rate}}" type="number" class="form-control py-2 text-center" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate" name="p_rate[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <p class="py-2" style="font-family: 'Poppins', sans-serif;">{{$data->value}}</p> 
                                    ...
                                    <div class="col-sm-3 py-1">
                                        ...
                                        <label><b style="color: #6c757d">Overhead No</b></label>
                                            ...
                                            @foreach($formulaData as $data)
                                                <option <?php if($data->oh_id == $overhead_id) echo 'selected="selected"'; ?> style="text-transform: capitalizel" value="{{$data['oh_id'] }}">Overhead-{{$data['oh_id']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
