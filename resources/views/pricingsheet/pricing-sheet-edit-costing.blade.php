...
<div class="container-fluid px-5">
                            ...
                            @csrf
                                ...
                                <div id="cuttingrow">
                                    ...
                                    <div id="insolerow1{{$a1++}}" class="form-group row mb-0 text-center">
                                        ...
                                        <div class="col-sm-3 py-1">
                                            <p class="py-1" style="font-family: 'Poppins', sans-serif; text-transform: capitalize;">{{$data->description}}</p> 
                                        ...
                                        <div class="col-sm-1 py-1">
                                            ...
                                            <input hidden id="cut_component" value="{{$data->component}}" type="text" name="cut_component[]" style="border: 1px solid #bfbfbf;" class="form-control py-2 readonly" placeholder="Code" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                            ...
                            @csrf
                                ...
                                <div id="insolerow2">
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step="0.1" min="0" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize_o" id="i_rate_o" name="i_rate_m[]" placeholder="Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
    ...
    <div hidden class="row mb-5">
        <div class="col-lg-12 mb-5">
            <div class="card">
                <div class="card-body p-5">
                    <form action="{{url('pricing-sheet-update-costing')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div id="cuttingrow">
                            ...
                            <div id="insolerow1{{$a1++}}" class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate" name="cut_rate[]" placeholder="Rate">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_val" name="cut_val[]" placeholder="Value">
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div id="insolerow">
                            ...
                            <div id="insolerow2{{$b1++}}" class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate" name="i_rate[]" placeholder="Rate">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_val" name="i_val[]" placeholder="Value">
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div id="laminationrow">
                            ...
                            <div id="insolerow3{{$c1++}}" class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate" name="lam_rate[]" placeholder="Rate">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_val" name="lam_val[]" placeholder="Value">
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div id="closingrow">
                            ...
                            <div id="insolerow4{{$d1++}}" class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate" name="clo_rate[]" placeholder="Rate">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_val" name="clo_val[]" placeholder="Value">
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div id="lastingrow">
                            ...
                            <div id="insolerow5{{$e1++}}" class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate" name="last_rate[]" placeholder="Rate">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_val" name="last_val[]" placeholder="Value">
                                </div>
                            </div>
                            @endforeach
                            @endif
                        ...
                        <div id="packingrow">
                            ...
                            <div id="insolerow6{{$f1++}}" class="form-group row mb-2">
                                ...
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate" name="p_rate[]" placeholder="Rate">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_val" name="p_val[]" placeholder="Value">
                                </div>
                            </div>
                            @endforeach
                            @endif
