...
@section('content')
<?php $currentMonth = date("Y-m"); $count = 1;?>
    ...
    <div class="row">
        @if(isset($dep))
            <div class="col-sm-4 mb-1 mb-sm-0">
                <form action="{{url('get-attendance')}}" id="myForm" method="post" enctype="multipart/form-data">
                    @csrf
                ...
                <span style="display: flex;">
                    ...
                    @if(isset($empCode))
                    <input value="{{$empName}} - {{$empCode}}" readonly type="text" class="form-control py-2 bg-white" style="border: 1px solid #bfbfbf; text-transform: capitalize;" id="emp_name1" name="emp_name1" placeholder="Select User">
                    @else
                    <input readonly type="text" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize;" id="emp_name1" name="emp_name1" placeholder="Select User">
                    @endif                     
                    <input hidden type="text" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize;" id="emp_name" name="emp_name" placeholder="Select User">
                        <span>
                        ...
                        <table id="datatable2" class="table dt-responsive nowrap text-center" 
                            ...
                            <tbody>
                                ...
                                <tr class="table_row">
                                    ...
                                    <td><img id="image321" style="transition: transform .5s;" src="img/avatars/avatar-2.jpg" alt="user" class="rounded-circle thumb-sm mr-1 ml-3"><b style="font-weight: 500;">{{$data[0]['name']}}</b></td>
                                    <td>{{$data[0]['code']}}</td>
