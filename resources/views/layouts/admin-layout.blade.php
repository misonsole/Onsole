         ...
         <ul class="metismenu left-sidenav-menu">
            ...
            <li>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{url('login-logs')}}"><i class="ti-control-record"></i>Login Logs</a></li>
            ...
            <li class="{{ Request::path() == 'transfer-ledger-report' ? 'mm-active active' : Request::path() == 'comparison-report' ? 'mm-active active' : Request::path() == 'item-purchase-report' ? 'mm-active active' : Request::path() == 'joborder-report' ? 'mm-active active' : Request::path() == 'purchase-invoice-report' ? 'mm-active active' : Request::path() == 'consumption-comparison' ? 'mm-active active' : Request::path() == 'consumption-report' ? 'mm-active active' : Request::path() == 'rma-report' ? 'mm-active active' : Request::path() == 'transferagainst-report' ? 'mm-active active' : Request::path() == 'joborder-journey' ? 'mm-active active' : Request::path() == 'purchase-order-report' ? 'mm-active active' : Request::path() == 'sales-order-report' ? 'mm-active active' : Request::path() == 'sales-report' ? 'mm-active active' : Request::path() == 'purchase-report' ? 'mm-active active' : Request::path() == 'transfer-report' ? 'mm-active active' : Request::path() == 'helpdesk-report' ? 'mm-active active' : Request::path() == 'adjustment-report' ? 'mm-active active' : Request::path() == 'material-report' ? 'mm-active active' : Request::path() == 'workorder-report' ? 'mm-active active' : '' }}">
                <a href="javascript: void(0);" class="{{ Request::path() == 'transfer-ledger-report' ? 'active' : Request::path() == 'comparison-report' ? 'active' : Request::path() == 'item-purchase-report' ? 'active' : Request::path() == 'joborder-report' ? 'active' : Request::path() == 'purchase-invoice-report' ? 'active' : Request::path() == 'consumption-comparison' ? 'active' : Request::path() == 'consumption-report' ? 'active' : Request::path() == 'rma-report' ? 'active' : Request::path() == 'transferagainst-report' ? 'active' : Request::path() == 'joborder-journey' ? 'active' : Request::path() == 'purchase-order-report' ? 'active' : Request::path() == 'sales-order-report' ? 'active' : Request::path() == 'sales-report' ? 'active' : Request::path() == 'purchase-report' ? 'active' : Request::path() == 'adjustment-report' ? 'active' : Request::path() == 'transfer-report' ? 'active' : Request::path() == 'helpdesk-report' ? 'active' : Request::path() == 'workorder-report' ? 'active' : '' }}"><i class="ti-layers-alt"></i><span>Reports</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
