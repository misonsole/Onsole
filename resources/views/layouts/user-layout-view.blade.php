...
<div class="topbar">
    ...
    <nav class="navbar-custom px-5">    
        <ul class="list-unstyled topbar-nav float-right mb-0"> 
            <li class="mt-3 mr-5" hidden>
                <a onclick="topFunction()" style="font-family: revert;" data-scroll> <button style="transition: all 0.15s ease-in-out; box-shadow: none;" type="button" class="btn btn-dark">Material</button></a>
                <a href="#section2"><button style="transition: all 0.15s ease-in-out; box-shadow: none;" data-scroll type="button" class="btn btn-dark">Resources</button></a> 
                <a href="#section3"><button style="transition: all 0.15s ease-in-out; box-shadow: none;" data-scroll type="button" class="btn btn-dark">Overheads</button></a> 
            </li>
            <li class="dropdown notification-list ml-5">
                    ...
                    <div style="overflow-y: scroll; max-height: 270px;" class="notification-list">
                        @foreach($notification as $val)
                            ...
                            @else
                                ...
                                @endif
                            @endif
                                @if($val->event == 'Job Order' || $val->event == 'Job Order Approved' || $val->event == 'Job Order Reject' || $val->event == 'Job Order Transferred')
                                ...
                                @endif                                  
                                    ...
                                    <div class="media">
                                        ...
                                        @elseif($val->event == 'Job Order Approved')
                                            <img style="margin-left: -6px;" src="img/avatars/yesbg3.png" alt="user" class="thumb-sm">
                                        @elseif($val->event == 'Job Order Transferred')
                                            <img style="margin-left: -6px;" src="img/avatars/yesbg3.png" alt="user" class="thumb-sm">
                                        @elseif($val->event == 'Job Order Reject')
    ...
    <div class="left-sidenav">
         <ul class="metismenu left-sidenav-menu">
            ...
            <li class="{{ Request::path() == 'get-attendance' ? 'mm-active active' : Request::path() == 'get-user-attendance' ? 'mm-active active' : '' }}">
                <a href="javascript: void(0);" class="{{ Request::path() == 'get-attendance' ? 'active' : Request::path() == 'get-user-attendance' ? 'active' : '' }}"><i class="ti-agenda"></i><span>Attendance</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
            ...
            @if(isset($storeData['Objective-List']) && !empty($storeData['Objective-List'])) 
                ...
                <li class="{{ Request::path() == 'obj-department' ? 'mm-active active' : Request::path() == 'obj-department-1' ? 'mm-active active' : Request::path() == 'show-obj' ? 'mm-active active' : Request::path() == 'objective-create' ? 'mm-active active' : '' }}">
                    <a href="javascript: void(0);" class="{{ Request::path() == 'obj-department' ? 'active' : Request::path() == 'obj-department-1' ? 'active' : Request::path() == 'show-obj' ? 'active' : Request::path() == 'objective-create' ? 'active' : '' }}"><i class="ti-bookmark"></i><span>Objectives</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="nav-second-level" aria-expanded="false">
            ...
            @endif
            @if(isset($storeData['Job-Order List']) && !empty($storeData['Job-Order List']) || isset($storeData['Quality-Control']) && !empty($storeData['Quality-Control']) || isset($storeData['Production-Planning-Control']) && !empty($storeData['Production-Planning-Control']) || isset($storeData['Pricing-Sheet List']) && !empty($storeData['Pricing-Sheet List']) || isset($storeData['Pricing-Sheet Costing']) && !empty($storeData['Pricing-Sheet Costing']) || isset($storeData['Pricing-Sheet Sales']) && !empty($storeData['Pricing-Sheet Sales'])) 
                @if(isset($storeData['Job-Order List']) == 1 || isset($storeData['Quality-Control']) == 1 || isset($storeData['Production-Planning-Control']) == 1 || isset($storeData['Pricing-Sheet List']) == 1 || isset($storeData['Pricing-Sheet Costing']) == 1 || isset($storeData['Pricing-Sheet Sales']) == 1)
                <li class="{{ Request::path() == 'pricing-sheet-edit' ? 'mm-active active' : Request::path() == 'obj-department' ? 'mm-active active' : Request::path() == 'pricing-sheet-view' ? 'mm-active active' : '' }}">
                    <a href="javascript: void(0);" class="{{ Request::path() == 'pricing-sheet-edit' ? 'active' : Request::path() == 'obj-department' ? 'active' : Request::path() == 'pricing-sheet-view' ? 'active' : '' }}"><i class="ti-files"></i><span>PDL</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="nav-second-level p-0" aria-expanded="false">
                        ...
                        @if(isset($storeData['Pricing-Sheet Create']) && !empty($storeData['Pricing-Sheet Create'])) 
                            @if(isset($storeData['Pricing-Sheet Create']) == 1)
                                <li class="nav-item"><a class="nav-link" href="{{url('pricing-sheet')}}"><i class="ti-control-record"></i>Create Pricing Sheet</a></li> 
                            @endif
                        @endif
                        @if(isset($storeData['Pricing-Sheet List']) && !empty($storeData['Pricing-Sheet List']) || isset($storeData['Pricing-Sheet Costing']) && !empty($storeData['Pricing-Sheet Costing']) || isset($storeData['Pricing-Sheet Sales']) && !empty($storeData['Pricing-Sheet Sales'])) 
                            @if(isset($storeData['Pricing-Sheet List']) == 1 || isset($storeData['Pricing-Sheet Costing']) == 1  || isset($storeData['Pricing-Sheet Sales']) == 1)
                                <li class="{{  Request::path() == 'pricing-sheet-edit' ? 'nav-item active' : Request::path() == 'pricing-sheet-view' ? 'nav-item active' : 'nav-item' }}"><a class="{{  Request::path() == 'pricing-sheet-edit' ? 'nav-link active' : Request::path() == 'pricing-sheet-view' ? 'nav-link active' : 'nav-link' }}" href="{{url('pricing-sheet-table')}}"><i class="ti-control-record"></i>Manage Pricing Sheet</a></li>
                            @endif
                        @endif
                    </ul>
                </li>                      
