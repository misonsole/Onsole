    ...
    <div class="row px-2">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Assign Book</h4>
            </div>
        </div>
    </div>
                    ...
                    @csrf
                        <div class="form-group row py-2">
                            <div class="col-sm-12 mb-1 mb-sm-0">
                                ...
                                <select id="role" name="role" class="select2 form-control mb-3 custom-select" style="border: 1px solid #bfbfbf;" required>
                            ...
                            <div class="col-sm-12">
                                ...
                                <select class="select2 mb-3 select2-multiple form-control text-dark px-2 py-2 bg-dark" id="mySelect9" name="books[]" style="border: 1px solid #bfbfbf; width: 100%; padding-top: 20px;" multiple="multiple" data-placeholder=" Choose Books" required>
                                    @foreach($book as $value)                            
                                        <option value="{{$value['key_id']}}">{{$value['book']}}</option>
                                    @endforeach
                                </select>                    
                            </div>
                        </div>
                        <div class="form-group row py-3 mt-5" style="margin-bottom: 0px;">
                            <div class="col-sm-12">
                                <span class="btn px-5 py-1 btn-lg btn-block text-white" id="save" style="border: none; font-size: 17px; background: linear-gradient(14deg, #1761fd 0%, rgba(23, 97, 253, 0.6)); cursor: pointer;">Submit</span>
                            </div>
                        </div>                        
                    </form>
                </div>
