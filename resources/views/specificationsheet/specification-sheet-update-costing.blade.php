            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-family: 'Poppins', sans-serif;">Specification Sheet Update</li>
                    </ol>
                </div>
                <h4 class="page-title">Specification Sheet Update</h4>
            </div>
        </div>
    </div>
    <div class="row mb-5">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active p-3" id="home-1" role="tabpanel">
                            <form action="{{url('specification-sheet-update-material-edit')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-sm-9 col-md-9 py-0">
                                        ...
                                        <div class="form-group row py-0">
                                            ...
                                            <div class="col-sm-3 col-md-3 py-1">
                                                ...
                                                <input value="{{$userdesign}}" type="text" class="form-control py-2 yourclass readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="design" name="design" placeholder="Enter Design No" required>
                                            </div>
                                            <div class="col-sm-3 col-md-3 py-1">
                                        ...
                                        <div class="form-group row py-0">
                                            ...
                                            <div class="col-sm-3 col-md-3 py-1">
                                                ...
                                                <input value="{{$userproduct}}" id="product" name="product" type="text" class="form-control yourclass readonly" style="border: 1px solid #bfbfbf;" placeholder="Enter Product Name">
                                            </div>
                                ...
                                <div id="cuttingrow">
                                    ...
                                    <div id="insolerow1{{$a1++}}" class="form-group row mb-2">
                                        <div class="col-sm-1 py-1" style="display: inline-flex;">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="text" value="{{$data->description}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description1" name="cut_description[]" placeholder="Enter Description" required>
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->fac_qty}}" type="number" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_fac" name="cut_fac[]" placeholder="Factor">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->total_qty}}" type="number" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_qty" name="cut_qty[]" placeholder="Quantity">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->process}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_process" name="cut_process[]" placeholder="%">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->total}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_total_con" name="cut_total_con[]" placeholder="Total">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->rate}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate" name="cut_rate[]" placeholder="Rate" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->value}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_val" name="cut_val[]" placeholder="Value">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                                ...
                                <div id="insolerow">
                                    ...
                                    <div id="insolerow2{{$b1++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="text" value="{{$data->description}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_description1" name="i_description[]" placeholder="Enter Description">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_fac" name="i_fac[]" placeholder="Factor">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_qty" name="i_qty[]" placeholder="Quantity">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->process}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_process" name="i_process[]" placeholder="%">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_total_con" name="i_total_con[]" placeholder="Total">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->rate}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate" name="i_rate[]" placeholder="Rate" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->value}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_val" name="i_val[]" placeholder="Value">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                                ...
                                <div id="laminationrow">
                                    ...
                                    <div id="insolerow3{{$c1++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="text" value="{{$data->description}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_description1" name="lam_description[]" placeholder="Enter Description">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_fac" name="lam_fac[]" placeholder="Factor">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_qty" name="lam_qty[]" placeholder="Quantity">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->process}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_process" name="lam_process[]" placeholder="%">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_total_con" name="lam_total_con[]" placeholder="Total">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->rate}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate" name="lam_rate[]" placeholder="Rate" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->value}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_val" name="lam_val[]" placeholder="Value">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                                ...
                                <div id="closingrow">
                                    ...
                                    <div id="insolerow4{{$d1++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="text" value="{{$data->description}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_description1" name="clo_description[]" placeholder="Enter Description">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_fac" name="clo_fac[]" placeholder="Factor">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_qty" name="clo_qty[]" placeholder="Quantity">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->process}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_process" name="clo_process[]" placeholder="%">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_total_con" name="clo_total_con[]" placeholder="Total">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->rate}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate" name="clo_rate[]" placeholder="Rate" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->value}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_val" name="clo_val[]" placeholder="Value">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                                ...
                                <div id="lastingrow">
                                    ...
                                    <div id="insolerow5{{$e1++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_fac" name="last_fac[]" placeholder="Factor">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_qty" name="last_qty[]" placeholder="Quantity">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->process}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_process" name="last_process[]" placeholder="%">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_total_con" name="last_total_con[]" placeholder="Total">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->rate}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate" name="last_rate[]" placeholder="Rate" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->value}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_val" name="last_val[]" placeholder="Value">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                                ...
                                <div id="packingrow">
                                    ...
                                    <div id="insolerow6{{$f1++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="text" value="{{$data->description}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_description1" name="p_description[]" placeholder="Enter Description">
                                        ...
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->fac_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_fac" name="p_fac[]" placeholder="Factor">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total_qty}}" step=".01" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_qty" name="p_qty[]" placeholder="Quantity">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->process}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_process" name="p_process[]" placeholder="%">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input type="number" value="{{$data->total}}" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_total_con" name="p_total_con[]" placeholder="Total">
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->rate}}" type="number" class="form-control py-2" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate" name="p_rate[]" placeholder="Rate" required>
                                        </div>
                                        <div class="col-sm-1 py-1">
                                            <input value="{{$data->value}}" type="number" class="form-control py-2 readonly" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_val" name="p_val[]" placeholder="Value">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                            ...
                            @csrf
                                <div id="cuttingrow1">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description_r" name="cut_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate_r" name="cut_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                    ...
                                    <div id="insole1row1{{$a11++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description_r" name="cut_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate_r" name="cut_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="insolerow1">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_description_r" name="i_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate_r" name="i_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole1row2{{$b11++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_description_r" name="i_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate_r" name="i_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="laminationrow1">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_description_r" name="lam_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate_r" name="lam_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole1row3{{$c11++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_description_r" name="lam_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate_r" name="lam_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="closingrow1">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_description_r" name="clo_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate_r" name="clo_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole1row4{{$d11++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_description_r" name="clo_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate_r" name="clo_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="lastingrow1">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_description_r" name="last_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate_r" name="last_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole1row5{{$e11++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_description_r" name="last_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate_r" name="last_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="packingrow1">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_description_r" name="p_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate_r" name="p_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole1row6{{$f11++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_description_r" name="p_description_r[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate_r" name="p_rate_r[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                            ...
                            @csrf
                                <div id="cuttingrow2">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description_o" name="cut_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate_o" name="cut_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole2row1{{$a111++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description_o" name="cut_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_rate_o" name="cut_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="insolerow2">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_description_o" name="i_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate_o" name="i_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole2row2{{$b111++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_description_o" name="i_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="i_rate_o" name="i_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="laminationrow2">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_description_o" name="lam_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate_o" name="lam_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole2row3{{$c111++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_description_o" name="lam_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_rate_o" name="lam_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="closingrow2">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_description_o" name="clo_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate_o" name="clo_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole2row4{{$d111++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_description_o" name="clo_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_rate_o" name="clo_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="lastingrow2">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_description_o" name="last_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate_o" name="last_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole2row5{{$e111++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_description_o" name="last_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_rate_o" name="last_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                ...
                                <div id="packingrow2">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_description_o" name="p_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate_o" name="p_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
                                    ...
                                    <div id="insole2row6{{$f111++}}" class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5 py-1">
                                            <input value="{{$data->description}}" type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_description_o" name="p_description_o[]" placeholder="Enter Description">
                                        </div> 
                                        <div class="col-sm-2 py-1">
                                        ...
                                        <div class="col-sm-2 py-1">
                                            <input value="{{$data->pair}}" type="number" step=".01" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_rate_o" name="p_rate_o[]" placeholder="Enter Rate">
                                        </div>
                                        <div class="col-sm-1 py-1 text-center">
