                                    ...
                                    @foreach($data as $user) 
                                        <tr class="table_row">
                                            ...
                                            <td class="text-center" style="width: 10%;">
                                                ...
                                                @elseif($user->status == "PPC")
                                                <span class="badge badge-md badge-boxed badge-soft-warning py-2 px-3 w-100">Production-Planning-Control</span>
                                                ...
                                                @else
                                                <span class="badge badge-md badge-boxed badge-soft-dark p-2 w-100">{{$user->status}}</span>
                                                @endif
                                            </td>
                                                        ...
                                                        @if($user->progress != '100')
                                                            <select id="status" data-id="{{$user->id}}" name="status" style="border: 1px solid #bfbfbf; text-transform: capitalize" class="form-control status custom-select text-center">
                                                                @if($user->status == 'Costing')                                                    
                                                                    ...
                                                                    <option <?php if ($user->status == "Reject") echo "selected"; ?> value="Rejected">Reject</option>
                                                                @endif
                                                            </select>
                                                        @else
                                                    ...
                                                    @if(isset($storeData['Pricing-Sheet Costing']) == 1)
                                                        @if($user->progress == 90)
                                                            @if($user->status != "Sales")
                                                                <span><a id="calculate" data-id={{$user['id']}} style="font-size: small; cursor: pointer; border: none;" class="btn ModelBtn ml-2 py-0 px-2 rounded-circle"> <i style="font-size: x-large;" class="mdi mdi-finance"></i></a></span>                        
                                                            @endif   
                                                        @endif    
                                                    @endif
                                                @endif
...
<script>
    $('.status').on('change', function(){
        ...
        if(status == 'Costing'){
            ...
            var line = 'Are you sure Transfer to Production Department?';
            var line1 = 'Transfer';
        }
