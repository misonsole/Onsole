                                                ...
                                                @if(isset($storeData['Quality-Control']) == 1)
                                                    <td style="width: 13%;">
                                                        ...
                                                        <select id="status" data-id="{{$user->id}}" name="status" style="border: 1px solid #bfbfbf; text-transform: capitalize" class="form-control status custom-select text-center">
                                                            @if($user->status == 'QC')           
                                                                <option <?php if ($user->status == "QC") echo "selected"; ?> value="QC" disabled>Quality Control</option>                                         
                                                                <option <?php if ($user->status == "PD") echo "selected"; ?> value="PD">Update</option>
                                                                <option <?php if ($user->status == "Production") echo "selected"; ?> value="Production">Approve</option>
