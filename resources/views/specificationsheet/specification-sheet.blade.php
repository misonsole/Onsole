                    ...
                    @csrf
                            ...
                            <div class="col-sm-8 col-md-8 py-0">
                                ...
                                <div class="form-group row py-0">
                                    ...
                                    <div class="col-sm-6 col-md-6 py-1">
                                        ...
                                        <span style="display: flex;">
                                            <input readonly type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="design" name="design" placeholder="Enter Design No" required>
                                            <span>
                                ...
                                <div class="form-group row py-0">
                                    ...
                                    <div class="col-sm-3 col-md-3 py-1">
                                        ...
                                        <input id="product" name="product" type="text" class="form-control yourclass" style="border: 1px solid #bfbfbf;" placeholder="Enter Product Name" required>
                                    </div>
                                    <div class="col-sm-6 col-md-6 py-1">
                            ...
                            <div class="col-sm-4 col-md-4 py-1">
                                <div class="form-group row py-0">
                                    <div class="col-md-6 py-0">
                                        ...
                                        <div class="row py-2">
                                            <div class="col-sm-12">
                                                <label class="mt-0"><b style="color: #6c757d">Sequence</b></label>
                                    ...
                                    <div class="col-md-6 py-1">
                                        ...
                                        <input type="file" name="image" id="input-file-now-custom-1" class="dropify" data-default-file="img/photos/23.jpg" required/><br>
                        ...
                        <div id="cuttingrow">
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span class="w-100">
                                        <input readonly id="cut_item_code1" type="text" style="border: 1px solid #bfbfbf;" name="cut_item_code[]" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-3 py-1">
                                    <input readonly type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_description1" name="cut_description[]" placeholder="Description">
                                </div>
                                <div class="col-sm-1 py-1">
                                    <input readonly type="text" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="cut_uom1" name="cut_uom[]" placeholder="Unit">
                                </div> 
                                <div class="col-sm-2 py-1">
                        ...
                        <div id="insolerow">
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span class="w-100">
                                        <input readonly id="i_item_code1" type="text" style="border: 1px solid #bfbfbf;" name="i_item_code[]" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                        ...
                        <div id="laminationrow">
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span class="w-100">
                                        <input readonly id="lam_item_code1" type="text" style="border: 1px solid #bfbfbf;" name="lam_item_code[]" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1">
                                    <input min="0" type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="lam_process" name="lam_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                        ...
                        <div id="closingrow">
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span class="w-100">
                                        <input readonly id="clo_item_code1" type="text" style="border: 1px solid #bfbfbf;" name="clo_item_code[]" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1">
                                    <input min="0" type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="clo_process" name="clo_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                        ...
                        <div id="lastingrow">
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span class="w-100">
                                        <input readonly id="last_item_code1" type="text" style="border: 1px solid #bfbfbf;" name="last_item_code[]" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1">
                                    <input min="0" type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="last_process" name="last_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
                        ...
                        <div id="packingrow">
                            <div class="form-group row mb-2">
                                <div class="col-sm-2 py-1" style="display: inline-flex;">
                                    <span class="w-100">
                                        <input readonly id="p_item_code1" type="text" style="border: 1px solid #bfbfbf;" name="p_item_code[]" class="form-control py-2 yourclass" placeholder="Item Code">                                        
                                    </span>
                                    <span>
                                ...
                                <div class="col-sm-1 py-1">
                                    <input min="0" type="number" class="form-control py-2 yourclass" style="border: 1px solid #bfbfbf; text-transform: capitalize" id="p_process" name="p_process[]" placeholder="%">
                                </div>
                                <div class="col-sm-1 py-1" hidden>
...
$(document).ready(function(){ 
    ...
    $("#Check").on('click',function(){
        ...
        if(count1 == '' && count2 == '' && count3 == '' && count4 == '' && count5 == '' && count6 == ''){
            ...
            Swal.fire({
                icon: 'warning',
                text: "Attachment is Missing",
            });
        }
        else{
            $("#myForm").attr("method", "post");
            $("#myForm").attr("enctype", "multipart/form-data");
            $("#myForm").attr("action", "specification-sheet-create");
...
<script src="assets/js/specificationsheet.js"></script>
<script>
