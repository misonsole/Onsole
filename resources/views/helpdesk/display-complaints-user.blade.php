                            ...
                            <div class="card-body p-5">
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <img id="image321" style="transition: transform .5s;" class="d-flex mr-3 rounded-circle thumb-md" src="{{ asset('uploads/appsetting/' . $user['image']) }}" alt="Generic placeholder image">
                                        @else
                                        <img id="image321" style="transition: transform .5s;" class="d-flex mr-3 rounded-circle thumb-md" src="img/avatars/avatar-2.jpg" alt="Generic placeholder image">
                                        @endif 
                                    ...
                                    @if($value['data']['sender'] == Auth::user()->id)                                        
                                        <div class="media my-2">                                                        
                                            <div class="media-body reverse px-1">
                                                ...
                                                <?php $month1 = $value['data']['update_time']; $delimiter = ' '; $words1 = explode($delimiter, $month1); ?>
                                                    <small class="text-muted">{{$words1[1]}} {{$words1[2]}}</small>
                        ...
                        $.ajax({     
                            ...
                            success: function(data){
                                ...
                                for(let i = 0; data.present.length > i;  i++){
                                    if(data.present[i].data.sender == 222){
                                        ...
                                        $("#msg2").append('<div class="media my-2"> '+                                                       
                                                                '<div class="media-body reverse px-1">'+
                                                                    '<div class="chat-msg mt-1" style="float: right;">'+                                                
                                                                    '<small class="text-muted px-1">'+myArray[1]+' '+myArray[2]+'</small>'+
                                    ...
                                    else if(data.present[i].data.sender != 222){
                                        const myArray = data.present[i].data.update_time.split(" ");
